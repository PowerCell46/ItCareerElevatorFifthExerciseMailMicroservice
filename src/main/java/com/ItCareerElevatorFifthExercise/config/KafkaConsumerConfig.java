...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, SendMailMessageDTO> userLocationConsumerFactory() {
        ...
        JacksonJsonDeserializer<SendMailMessageDTO> valueDeserializer = new JacksonJsonDeserializer<>(SendMailMessageDTO.class);
