    ...
    public void sendMessageToReceiverThroughEmail(SendMailMessageDTO sendMailMessageDTO) {
        try {
            ...
            helper.setSubject(String.format(
                    ...
                    sendMailMessageDTO.getSenderUsername(),
                    LocalDateTime.now().format(DateTimeFormatter.ofPattern("MMM dd, yyyy HH:mm"))
            ));

            helper.setText(formatMessageBody(
                            sendMailMessageDTO.getContent(),
                            sendMailMessageDTO.getSenderUsername(),
                            sendMailMessageDTO.getSentAt()),
                    true);

            log.info("Sending email message notification to {}.", sendMailMessageDTO.getReceiverEmail());
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p class="intro-text">
                                ...
                                PowerCell brings seamless, real-time messaging to your fingertips. Get started 
                            ...
                            <a href="[YOUR_APP_URL]/login" class="cta-button">Get Started Now</a>
                            
                            <div class="security-note">
                                <strong>🔒 Security Tip:</strong> Never share your password with anyone. 
                                PowerCell staff will never ask for your password via email. If you didn't create 
                        ...
                        <div class="footer">
                            <div class="footer-links">
                                <a href="[YOUR_APP_URL]">Home</a>
                                <a href="[YOUR_APP_URL]/help">Help Center</a>
                                <a href="[YOUR_APP_URL]/privacy">Privacy Policy</a>
                                <a href="[YOUR_APP_URL]/contact">Contact Us</a>
                            </div>
                            <p class="footer-text">
                                © 2025 PowerCell. All rights reserved.
                            </p>
                            <p class="footer-text">
